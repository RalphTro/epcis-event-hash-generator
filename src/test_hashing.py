...
def testHashingWithVariousEventTypes():
    assert xmlEpcisHash("../testFiles/epcisDocWithVariousEventTypes.xml", "sha256") == [
        ...
        'ni:///sha-256;fa65cd8fd2da608387b992e86e7a4fdc04d3108c750b5e8888ecd7b1172ef58e',
        'ni:///sha-256;fa65cd8fd2da608387b992e86e7a4fdc04d3108c750b5e8888ecd7b1172ef58e',
        'ni:///sha-256;ebc119e75f8787dfc99798f18f93fd968f0b6ee6796d7e708037e4836e06ae9f'
    ]

def testHashingWithTagAndError():
    assert xmlEpcisHash("../testFiles/epcisDocWithXMLstartTagAndErrorDeclaration.xml", "sha256") == ["ni:///sha-256;cf346155eba383584e99334d0b1222e8895f607e0e2a9ed1be58cc36a7de5d64"]
